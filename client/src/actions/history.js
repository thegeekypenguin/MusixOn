...
import {GET_HISTORY,HISTORY_ERRORS,ADD_SONG_HISTORY_FAIL,HISTORY_CHECK,ADD_SONG_HISTORY_SUCESS,REMOVE_SONG_HISTORY} from "./types";
...
export const addCurrentSongInHistory = ({title,subtitle,img_url}) => async(dispatch)=>{
    const config = {
        headers:{
    ...
    const body = JSON.stringify({title,subtitle,img_url});
